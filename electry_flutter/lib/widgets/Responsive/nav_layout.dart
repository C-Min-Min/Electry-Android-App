...
class NavLayout extends StatefulWidget {
  ...
  NavLayout(this.privileges) : super();
  @override
...
class _NavLayoutState extends State<NavLayout> {
  ...
  void initState() {
    ...
    _screens = [
      HomeLayout(privileges),
      DeviceLayout(privileges),
      Scaffold(),
      Scaffold(),
      Scaffold(),
    ];
    ...
    return DefaultTabController(
      ...
      child: Builder(builder: (context) {
        ...
        return Scaffold(
            ...
            bottomNavigationBar: Responsive.isTabletPortrait(context) ||
                    Responsive.isMobilePortrait(context)
                ? Padding(
